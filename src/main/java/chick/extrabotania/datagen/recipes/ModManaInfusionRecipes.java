...
public class ModManaInfusionRecipes extends RecipeProvider
{
    ...
    {
        return new ResourceLocation(ExtraBotania.MODID, "mana_infusion/" + s);
    }
    ...
    protected static class ManaInfusion implements FinishedRecipe
    {
        ...
        private static final StateIngredient TEST = StateIngredientHelper.of(Registration.YLG_ORE.get());
