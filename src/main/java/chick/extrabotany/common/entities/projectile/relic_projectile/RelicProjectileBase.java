...
public abstract class RelicProjectileBase extends ThrowableProjectile
{
    ...
    private static final EntityDataAccessor<Float> ROTATION = SynchedEntityData.defineId(RelicProjectileBase.class,
            EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> PITCH = SynchedEntityData.defineId(RelicProjectileBase.class,
            EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<BlockPos> TARGET_POS = SynchedEntityData.defineId(RelicProjectileBase.class,
            EntityDataSerializers.BLOCK_POS);
    private static final EntityDataAccessor<Float> TARGET_POS_X = SynchedEntityData.defineId(RelicProjectileBase.class,
            EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> TARGET_POS_Y = SynchedEntityData.defineId(RelicProjectileBase.class,
            EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> TARGET_POS_Z = SynchedEntityData.defineId(RelicProjectileBase.class,
            EntityDataSerializers.FLOAT);

    protected List<LivingEntity> attackedEntities = new ArrayList<>();
    protected float damageTime = 1;

    public RelicProjectileBase(EntityType<? extends ThrowableProjectile> type, Level level)
    {
        super(type, level);
    }

    public RelicProjectileBase(EntityType<? extends ThrowableProjectile> type, Level level, LivingEntity thrower, float damageTime)
    {
        super(type, level);
